...
| **4b-2. Obras — estoque + venda** | custo da obra em andamento vira ESTOQUE (ativo `1.2`, já criado na 2c) + evento de venda (reclassif. → CPV) + DRE Incorporadora por obra | dado operacional | 🟡 **capitalização APLICADA** (`20260718161547`): 58 custos/R$134.172,06 em estoque e obras vinculadas; 53 sem conta pagadora seguem com contrapartida pendente. Falta automatizar o evento venda → CPV |
